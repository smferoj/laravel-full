...
<head>
    ...
    <title>UniqueAgroCare - Admin Login</title>
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-4 pe-md-0">
                                    <div class="">
                                        <img src="{{ asset('uploads/login.png') }}" style="width: 100%; height: 100%">

                                    </div>
                                </div>
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#" class="noble-ui-logo logo-light d-block mb-2">Unique<span>UI</span></a>
